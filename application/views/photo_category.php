    ...
    <fieldset>
        ...
        if($list){
            ...
            <table class="table table-striped table-hover " style="font-size: 13px;">
                <tr><th>序号</th><th>分类名</th><th>操作</th></tr>
                <?php
                $i=1;
                foreach ($list as $value){
                    ...
                    <tr style="height:10px;">
                        ...
                        <td><span id="cat<?php echo $value['id'];?>" onclick="changeshow('<?php echo $value['id']; ?>')"><a><?php echo $value['name']; ?></a></span>
                            <form style="margin: 0;" id="cform<?php echo $value['id']; ?>" action="<?php echo site_url('product_category/edit/'.$value['id']); ?>" method="post">
                        ...
                        <td><a href="<?php echo site_url('product_category/delete/'.$value['id'])?>" onclick="return confirm('确定要删除？')">删除</a></td>
                    </tr>
                    <script>
