...
class Photo_category extends CI_Controller{

    public function __construct(){
        parent::__construct();
        $this->load->model('photo_category_model','category');
    }
    ...
    public function index($page = 1){
        ...
        $config['base_url'] = site_url('photo_category/index');
        ...
        $this->load->view('photo_category',$result);
    }
